...
--> global name declaration
		...
		_detalhes.build_counter = 6678
		_detalhes.alpha_build_counter = 6678 --if this is higher than the regular counter, use it instead
